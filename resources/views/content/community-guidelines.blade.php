...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    <h4 class="page-title"><i class="fas fa-home mr-1"></i> Community Guidelines</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('community-guidelines') }}">Community Guidelines</a></li>
                    </ol>
                </div><!--end col-->
            ...
            <div class="col">
                <div class="card">
                  @if ($errors->any())
                    ...
                    @endif
                    <div class="card-body">
                        <form action="{{ route('save-community-guidelines') }}" method="POST" >
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">

                                        <textarea class="mytextarea" id="mytextarea" name="content" >{!! $content->community_guidelines !!}</textarea>
                                        @error('name')
