        ...
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('registration.index') }}">Registration Approvals</a></li>
                        <li class="breadcrumb-item active">View Registration</li>
                    </ol>
                </div>
                <!--end col-->
                <div class="col-auto align-self-center">
                    <a href="{{ route('registration.index') }}" class="btn btn-sm btn-outline-primary" title="Go Back">
                                    ...
                                    <div class="col-lg-12 ms-auto align-self-center">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                @empty
                                                <div class="float-center">Business regions not updated!</div>
                                                @endforelse
                                            </div>
                                        </div>
                                        <!--end list-group-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                        <a href="{{ route('registration.checklist',$company->id) }}"
