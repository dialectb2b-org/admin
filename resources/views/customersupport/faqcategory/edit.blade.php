        ...
        <div class="page-title-box">
            <div class="row">
                ...
                <div class="col-auto align-self-center">
                    <a href="{{ route('faq-categories.index') }}" class="btn btn-sm btn-outline-primary" title="Go Back">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('faq-categories.update',$faq_category->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') parsley-error @enderror" placeholder="Enter name"
                                               id="name" name="name" value="{{ old('name') ?? $faq_category->name ?? '' }}" autofocus/>
                                        @error('name')
