        ...
        <div class="page-title-box">
            <div class="row">
                ...
                <div class="col-auto align-self-center">
                    ...
                    <a href="{{ route('sector.index') }}" class="btn btn-sm btn-outline-primary" title="List Of Unit">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sector.update',$sector) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') parsley-error @enderror"
                                               id="name" name="name" value="{{ old('name') ?? $sector->name }}" />
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('code') parsley-error @enderror" 
                                               id="code" name="code" value="{{ old('code') ?? $sector->code }}" />
                                        @error('code')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <img src = "{{ asset($sector->image ) }}" alt="No_Image" id="blah" height="150px" width="150px" />
                                    </div>
                                </div> -->
                            </div>
                            <div class="row">
