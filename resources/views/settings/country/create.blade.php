        ...
        <div class="page-title-box">
            <div class="row">
                ...
                <div class="col-auto align-self-center">
                    <!-- <a href="{{ route('country.index') }}" class="btn btn-sm btn-outline-primary" title="Help">
                        <i class="fas fa-question"></i>
                    </a> -->
                    <a href="{{ route('country.index') }}" class="btn btn-sm btn-outline-primary" title="List Of Countries">
                        <i class="fas fa-list"></i> List Of Countries
                    </a>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('iso3') parsley-error @enderror" 
                                               id="iso3" name="iso3" value="{{ old('iso3') }}" maxlength="3" placeholder="Enter iso3"/>
                                        @error('iso3')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('numeric_code') parsley-error @enderror" placeholder="Enter numeric code"
                                               id="numeric_code" name="numeric_code" value="{{ old('numeric_code') }}" maxlength="16" onkeypress="return onlyNumberKey(event)" />
                                        @error('numeric_code')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('phonecode') parsley-error @enderror"
                                               id="phonecode" name="phonecode" value="{{ old('phonecode') }}" maxlength="10" placeholder="Enter phonecode"/>
                                        @error('phonecode')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('capital') parsley-error @enderror"
                                               id="capital" name="capital" value="{{ old('capital') }}" placeholder="Enter capital"/>
                                        @error('capital')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('currency') parsley-error @enderror"
                                               id="currency" name="currency" value="{{ old('currency') }}" placeholder="Enter currency"/>
                                        @error('currency')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('currency_symbol') parsley-error @enderror"
                                               id="currency_symbol" name="currency_symbol" value="{{ old('currency_symbol') }}" placeholder="Enter currency symbol"/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('currency_name') parsley-error @enderror"
                                               id="currency_name" name="currency_name" value="{{ old('currency_name') }}" placeholder="Enter currency name"/>
                                        @error('currency_name')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('tld') parsley-error @enderror"
                                               id="tld" name="tld" value="{{ old('tld') }}" placeholder="Enter tld"/>
                                        @error('tld')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('native') parsley-error @enderror"
                                               id="native" name="native" value="{{ old('native') }}" placeholder="Enter native"/>
                                        @error('native')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
