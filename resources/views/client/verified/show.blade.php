            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('clients.verified.index') }}">Verified Clients</a></li>
                        <li class="breadcrumb-item active">{{ $company->name ?? '' }}</li>
                    </ol>
                </div>
                <!--end col-->
                <div class="col-auto align-self-center">
                    <a href="{{ route('clients.verified.index') }}" class="btn btn-sm btn-outline-primary" title="Go Back">
