            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">( Deactivated / Freeze)</li>
                    </ol>
                </div><!--end col-->
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <form action="{{ route('clients.disabled.index') }}" method="GET">
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="card-body">
                    <h4 class="card-title">Disabled Clients</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table mb-0 table-centered">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('clients.disabled.show',$client->id) }}">{{ $client->name }}</a></td>
                                    <td>{{ $client->email ?? '' }}</td>
                                    <td>{{ $client->phone  ?? '' }}</td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel11">
                                                <a class="dropdown-item" href="{{ route('clients.disabled.show',$client->id) }}">Show</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
