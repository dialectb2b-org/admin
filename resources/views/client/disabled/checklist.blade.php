            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('clients.disabled.index') }}">Disabled Clients</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('clients.disabled.show',$company->id) }}">{{ $company->name ?? '' }}</a></li>
                        <li class="breadcrumb-item active">Checklist</li>
                    </ol>
                </div>
                <!--end col-->
                <div class="col-auto align-self-center">
                    <a href="{{ route('clients.disabled.show',$company->id) }}" class="btn btn-sm btn-outline-primary"
                        title="Go Back">
