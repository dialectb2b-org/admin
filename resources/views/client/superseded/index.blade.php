            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Superseded</li>
                    </ol>
                </div>
                <!--end col-->
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form action="{{ route('clients.superseded.index') }}" method="GET">
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <!--end card-header-->
                        <div class="card-body">
                            <h4 class="card-title">Superseded Clients</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table mb-0 table-centered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('clients.superseded.show',$client->id) }}">{{ $client->name }}</a>
                                            </td>
                                            <td>{{ $client->email ?? '' }}</td>
                                            <td>{{ $client->phone  ?? '' }}</td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('clients.superseded.show',$client->id) }}">Show</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
